...
# Add a scenario to check that the favorite helper is not displayed when it shouldn't
  ...
  Scenario: I want to see favourite helper popup when a product is NOT part of my favouriteproducts
    Given I am a logged in B2C user
    And I tap the shoppingList button
    And I tap the tooltip view
    And I tap the shoppingListAddProduct button
  ...
  Scenario: I do NOT want to see favourite helper popup when a product is part of my favouriteproducts
    Given I am a logged in B2C user
    And I tap the jumboFloater
    And I set the value 74412PAK on the search field
    And I tap the enter button
    ...
    And I tap the payAtPickUp button
    And I tap the ok button
    Then the value Campina Halfvolle Melk Voordeelpak 2,4 Liter is not displayed on the favoritesHelper view